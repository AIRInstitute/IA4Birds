...
const signup = async (req: Request, res: Response) => {
    ...
    const url = `${globalConfig.frontendURL}/accept-decline-component?email=${encodeURIComponent(body.email)}&organization=${encodeURIComponent(body.organization)}&token=${activateAccountToken}`;
    const mailOptions = {
