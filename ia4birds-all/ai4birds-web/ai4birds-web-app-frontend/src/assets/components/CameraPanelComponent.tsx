...
const CameraPanelComponent = () => {
    ...
    const cameraPanelData = [
        { id: 1, name: 'Camera 1', location: '', views: '273 views', gpsData: "latitude: 40.416775, longitude: -3.703790", storageData: "15.5", status: "Activa", url: import.meta.env.HLS_BASE_URL },
