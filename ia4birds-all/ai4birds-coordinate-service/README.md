## ai4birds-coordinate-service API
...
```bash
sudo docker build -t ai4birds_coordinate_service .
sudo docker run -it --rm --name ai4birds-coordinate-service ai4birds_coordinate_service
```
...
sudo ai4birds_coordinate_service
```
