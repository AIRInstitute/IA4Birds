...
windmap_model = api.model('WindMapModel', {
    'lat': fields.Float(description='Latitud', required=True, example=41.85563222906876),
    'lon': fields.Float(description='Longitud', required=True, example=-5.5495918821608665),
    'z': fields.Integer(description='Altitud', required=True, example=50)
